"""
This script is called by the plugin-wrapper, ClassifierPlugin.js, which passes down the
...
from ClassifierPlugin import ClassifierPlugin
...
plugin = ClassifierPlugin(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
